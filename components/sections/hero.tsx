...
export function Hero() {
  return (
    <section
      id="home"
      className="relative flex min-h-[100svh] w-full flex-col justify-between overflow-hidden pt-32 pb-0 md:pt-40 md:pb-0"
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-6 text-center">
        ...
        <motion.h1
          ...
          className="font-serif italic text-[clamp(2.5rem,7vw,5.5rem)] font-normal leading-[1.04] tracking-tight text-white drop-shadow-[0_2px_20px_rgba(255,255,255,0.15)] text-balance uppercase"
        >
        ...
        >
          <a
            href="#contact"
            className="group inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-semibold text-black transition-all hover:bg-gold hover:shadow-[0_0_30px_rgba(212,175,55,0.5)]"
          >
          ...
          <a
            href="#services"
            className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-cosmos-200/40 px-7 py-3.5 text-sm font-medium text-white backdrop-blur-md transition-all hover:border-gold/50 hover:bg-cosmos-200/80 hover:text-gold"
          >
      ...
      <motion.div
        ...
        className="relative z-10 w-full overflow-hidden border-y border-white/10 bg-cosmos-400/50 py-3.5 backdrop-blur-md"
        style={{
